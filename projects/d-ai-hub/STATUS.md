...
- Working state: The canonical `main` fast-forwarded from `526e32f` to `740385b` after a clean remote-ahead check, then recorded the resolved BUG-002 state at `aacc3e8` and the independent recovery sample at `b8c7da9`; final `HEAD = origin/main = b8c7da9`, ahead/behind `0/0`, and the worktree is clean. Old worktrees remain untouched.

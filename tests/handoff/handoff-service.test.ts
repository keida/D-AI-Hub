...
const pemPrivateKeys = [
  { label: "PKCS#8 private key", value: "-----BEGIN PRIVATE KEY-----\nTUlJRVJvdW5kOVBLS1M4Qk9EWQ==\n-----END PRIVATE KEY-----", body: "TUlJRVJvdW5kOVBLS1M4Qk9EWQ==", footer: "-----END PRIVATE KEY-----" },
  { label: "RSA private key", value: "-----BEGIN RSA PRIVATE KEY-----\nTUlJRVJvdW5kOVJTQV9CT0RZ\n-----END RSA PRIVATE KEY-----", body: "TUlJRVJvdW5kOVJTQV9CT0RZ", footer: "-----END RSA PRIVATE KEY-----" },
  { label: "EC private key", value: "-----BEGIN EC PRIVATE KEY-----\nTUlJRVJvdW5kOUVDX0JPRFk=\n-----END EC PRIVATE KEY-----", body: "TUlJRVJvdW5kOUVDX0JPRFk=", footer: "-----END EC PRIVATE KEY-----" },
  { label: "OpenSSH private key", value: "-----BEGIN OPENSSH PRIVATE KEY-----\nb3BlbnNzaC1rZXktcm91bmQ5LWJvZHk=\n-----END OPENSSH PRIVATE KEY-----", body: "b3BlbnNzaC1rZXktcm91bmQ5LWJvZHk=", footer: "-----END OPENSSH PRIVATE KEY-----" },
] as const;

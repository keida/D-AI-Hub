...
describe("parseDAICommand", () => {
  it.each([
    ...
    ["@D-AI sync，然后核实 codex-quota-float", { kind: "sync", project: "然后核实 codex-quota-float" }],
    ["@D-AI sync, then verify codex-quota-float", { kind: "sync", project: "then verify codex-quota-float" }],
    ["@D-AI sync:codex-quota-float", { kind: "sync", project: "codex-quota-float" }],
    ["@D-AI sync：codex-quota-float", { kind: "sync", project: "codex-quota-float" }],
